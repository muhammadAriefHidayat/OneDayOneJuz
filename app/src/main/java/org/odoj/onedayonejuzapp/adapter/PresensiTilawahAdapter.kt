...
class PresensiTilawahAdapter(val laporan:Laporan,var tilawah:Boolean):Item<ViewHolder>() {


    private var mData = ArrayList<Laporan>()

    override fun bind(viewHolder: ViewHolder, position: Int) {
        viewHolder.itemView.tanggalsetoran_ListSetoran.text = laporan.tanggal
